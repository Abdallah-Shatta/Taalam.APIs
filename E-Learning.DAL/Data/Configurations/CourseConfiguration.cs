...
namespace E_Learning.DAL.Data.Configurations
{
    public class CourseConfiguration : IEntityTypeConfiguration<Course>
    {
        public void Configure(EntityTypeBuilder<Course> builder)
        {
            ...
            ////Data Seeding
            builder.HasData(
                new Course { Id = 1, Title = "C# From Zero To SuperHero", CategoryId = 1, UserId = 1 },
                new Course { Id = 2, Title = "Data Strcutre", CategoryId = 1, UserId = 1 },
                new Course { Id = 3, Title = "Diet", CategoryId = 2, UserId = 2 },
                new Course { Id = 4, Title = "GYM", CategoryId = 2, UserId = 2 }
                );
        }
    }
}
